...
@log_function
def generate_html_gallery(gallery_data, unique_focal_lengths, template_path, output_dir, root_dir, status_callback):
    try:
        # Process image paths
        ...
        try:
            output_html = template.render(gallery=gallery_data, focal_lengths=unique_focal_lengths)
        except Exception as e:
